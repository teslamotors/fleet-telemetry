...
func init() {
	...
	if err != nil {
		panic("unable to load America/Los_Angeles timezone")
	}
}
...
var datumTransformations = map[protos.Field][]DatumTransformer{
	...
	protos.Field_TpmsLastSeenPressureTimeRl:       {transformTimestamp},
	protos.Field_TpmsLastSeenPressureTimeFr:       {transformTimestamp},
	protos.Field_TpmsLastSeenPressureTimeFl:       {transformTimestamp},
	protos.Field_TpmsLastSeenPressureTimeRr:       {transformTimestamp},
	protos.Field_ScheduledChargingStartTime:       {transformTimestamp},
	protos.Field_SoftwareUpdateScheduledStartTime: {transformTimestamp},
}
...
// transformTimestamp converts a timestamp from Los Angeles time to UTC.
