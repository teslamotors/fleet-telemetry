...
* NATS: Configure using the config.json file. Subjects follow the pattern `{namespace}.{vin}.{topic}`
  * See detailed NATS information in the [NATS README](./datastore/nats/README.md)
